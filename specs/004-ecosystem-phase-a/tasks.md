...
- [x] Read ledger, claim row, inspect code and shared snippets.
- [x] Record Phase A specification and plan before code.
- [x] Add strip, marks, contextual banners and analytics.
- [x] Add llms/robots and grounded provider/service JSON-LD.

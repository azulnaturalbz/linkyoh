...
- [x] Read ledger, record dated prototype approval and claim UI row.
- [x] Inspect model, search, SEO and WOP contracts; write spec and plan.
- [x] Implement read-only smart search and conservative Checked evidence.
